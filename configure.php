...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/logiaudit.php')) => rename($file, determineSeparator('./src/'.$className.'.php')),
        str_contains($file, determineSeparator('src/SkeletonServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        str_contains($file, determineSeparator('src/Facades/logiaudit.php')) => rename($file, determineSeparator('./src/Facades/'.$className.'.php')),
        ...
        str_contains($file, determineSeparator('config/logiaudit.php')) => rename($file, determineSeparator('./config/'.$packageSlugWithoutPrefix.'.php')),
